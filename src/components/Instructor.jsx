  ...
  return (
    <div className="w-full flex justify-center py-10">
        <div className="relative w-full">
            ...
            alt="Striver"
            className="w-[45%] h-auto mx-auto object-contain"
            />

            <div className="absolute top-[24%] left-1/2 -translate-x-1/2">
            <div className="text-[#FF7E42] font-mont border border-[#FF7E42] px-3 py-1 rounded-3xl text-center">
                Meet Your Instructor
            </div>
            </div>

            <div className="w-full absolute top-[30%] left-1/2 -z-10 -translate-x-1/2">
            <div className="text-white font-mont text-3xl font-bold text-center">
                The Architecture for your Success
            </div>
            </div>

            <div className='w-[30%] absolute top-[50%] left-[10%] font-mont text-sm tracking-wider space-y-5'>
                <div>
